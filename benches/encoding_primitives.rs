...
mod benchmark {
    ...
    pub fn criterion_benchmark(c: &mut Criterion) {
        ...
        // Roundtrip all of the values as encoding primitives as a correctness/sanity check.
        // Save the encoded bytes of each value sequence; we'll check its length at the end of each
        // benchmark as another sanity check.
        ...
        binary_1_0_group.bench_function("write VarUInt", |b| {
            ...
            b.iter(|| {
                ...
                assert_eq!(encoded_length, encoded_var_uints.len());
            })
        });
        ...
        binary_1_0_group.bench_function("write VarInt", |b| {
            ...
            b.iter(|| {
                ...
                assert_eq!(encoded_length, encoded_var_ints.len());
            })
        });
